...
function CheckInventory(props) {
  ...
  if ( isInventory ) {
    return <MainPageInvenGrid isInventory={ isInventory } items={ myItems } setMyItems={ props.setMyItems } goldStatus={props.goldStatus} setGoldStatus={ props.setGoldStatus } />
  }
  else {
...
export default function Inventory({ myItems, setMyItems, goldStatus, setGoldStatus }) {
  ...
  return (
    <View style={styles.containerUnder}>
      ...
      <CheckInventory isInventory={ isInventory } myItems={ myItems } setMyItems={ setMyItems } goldStatus={goldStatus} setGoldStatus={ setGoldStatus } />
